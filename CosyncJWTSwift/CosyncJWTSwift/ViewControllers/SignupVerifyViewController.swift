...
//  under the License.
//
//  Created by Cosync, Inc on 1/31/20.
//
...
class SignupVerifyViewController: UIViewController {
    ...
    func showVerifySignupFailedAlert(){
        
        let alert = UIAlertController(title: "Verfiy Signup Failed", message: "You have entered an invalid code.", preferredStyle: .alert)
            ...
            CSRESTManager.shared.completeSignup(handle, code: code, onCompletion: { (err) in
                ...
                DispatchQueue.main.async {
                    ...
                    if let error = err {
                        ...
                        self.showVerifySignupFailedAlert()
                    } else {
